...
import { View, ActivityIndicator, Alert, StyleSheet, SafeAreaView, Modal, Button, Switch, Text } from 'react-native';
      ...
      >
        <View style={styles.modalOverlay}>
          <View style={styles.modalContainer}>
            <UpdateUserForm onSubmit={handleSubmit} selectedUser={selectedUser} />
